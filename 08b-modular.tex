...
\begin{frame}
  ...
  \begin{itemize}
    \item Sort $n$ numbers
    \pause
    \item Check if vertex $u$ is reachable from vertex $v$ in a graph with $n$ vertices and $m$ edges
    \pause
    \item Multiply two $n\times n$ matrices
    \pause
    \item Add two integers
    \pause
    \item Check if an integer $n$ is prime
    \pause
    \item Find $gcd(a,b)$ for inputs $a$ and $b$
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Polynomial times}
  \begin{itemize}
    \item Sort $n$ numbers
    \item Check if vertex $u$ is reachable from vertex $v$ in a graph with $n$ vertices and $m$ edges
    \item Multiply two $n\times n$ matrices
...
\begin{frame}
  \frametitle{When inputs contain a few numbers}
\end{frame}

\begin{frame}
  \frametitle{GCD and Power}
\end{frame}
...
\begin{frame}
  ...
  Suppose that we know that every non-zero integer $a$ has an inverse modulo $m$.
