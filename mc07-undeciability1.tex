...
\lecturetitle{Lecture 12a: Undecidability (1)\footnote{Based partly on lecture notes of {\em Models of Computation} course by Jeff Erickson.}} 
...
\begin{frame}
  ...
  \begin{itemize}
  \item We show that if {\sc Halt} is decidable, then {\sc Accept} is
    also decidable.
    \pause
  \item However, {\sc Accept is undecidable}.
    \pause
